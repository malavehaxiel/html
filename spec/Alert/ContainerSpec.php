...
namespace spec\MalaveHaxiel\Html\Alert;

use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

use MalaveHaxiel\Html\Alert\Handler;
use MalaveHaxiel\Html\Alert\Message;
use MalaveHaxiel\Html\Theme;
...
class ContainerSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('MalaveHaxiel\Html\Alert\Container');
    }
    ...
    function it_uses_magic_methods($handler)
    {
        ...
        // When - Expect
        $this->success('Success!')->shouldReturnAnInstanceOf('MalaveHaxiel\Html\Alert\Message');
        $this->info('Some information')->shouldReturnAnInstanceOf('MalaveHaxiel\Html\Alert\Message');
