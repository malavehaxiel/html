...
namespace spec\MalaveHaxiel\Html\Menu;
...
class MenuGeneratorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('MalaveHaxiel\Html\Menu\MenuGenerator');
    }
    ...
    function it_generate_menu_items($url)
    {
        ...
        // Expect
        $menu->shouldReturnAnInstanceOf('MalaveHaxiel\Html\Menu\Menu');
