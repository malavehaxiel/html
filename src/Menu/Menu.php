...
namespace MalaveHaxiel\Html\Menu;

use Closure;
use MalaveHaxiel\Html\Str;
use MalaveHaxiel\Html\Theme;
use MalaveHaxiel\Html\Access\VerifyAccess;
use MalaveHaxiel\Html\Access\AccessHandlerSetter;
...
class Menu
{
     ...
     *
     * @param array $values
     * @return \MalaveHaxiel\Html\Menu\Menu $this
     */
